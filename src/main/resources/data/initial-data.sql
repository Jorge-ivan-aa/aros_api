...
VALUES (
        ...
        '$2a$10$.biBNqaDu.jEg54Z5MSa6ukaZCDhehmHglmnlJgT8De1qe/3KKtae',
        'Calle 10 #12-30',
        '3001234567'
    ),
    (
        ...
        '$2a$10$N9qo8uLOickgx2ZMRZoMye.IJsg2gLbDd1.8a7.8e5Cne7e7QYjW',
        'Carrera 8 #15-45',
        '3002345678'
    ),
    (
...
-- ======================
INSERT INTO
    user_areas (id_user, id_area)
VALUES (1, 1), -- Carlos en Cocina
    (2, 2), -- María en Bar
...
VALUES
    ...
    (
        'Sopa de Pollo',
        'Sopa casera con pollo, papa y verduras',
        12000,
        1,
        15,
        TRUE
    ...
    (
        'Crema de Espinacas',
        'Crema suave de espinacas con queso',
        10000,
        1,
        12,
        TRUE
    ...
    (
        'Ajiaco Santafereño',
        'Tradicional ajiaco con pollo, papa y guascas',
        15000,
        1,
        25,
        TRUE
...
(
    'Puré de Papa',
    'Puré cremoso de papa con mantequilla',
    6000,
    1,
    15,
    TRUE
...
(
    'Pescado Frito',
    'Filete de pescado frito crujiente',
    20000,
    1,
    15,
    TRUE
...
(
    'Pollo Horneado',
    'Pollo entero horneado con especias',
    25000,
    4,
    30,
    TRUE
...
(
    'Cerveza Águila',
    'Cerveza nacional botella 330ml',
    8000,
    2,
    1,
    TRUE
...
(
    'Aguardiente',
    'Trago de aguardiente antioqueño',
    10000,
    2,
    NULL,
    TRUE
...
(
    ...
    'Menú completo: sopa + principio + proteína + bebida',
    25000,
    NULL,
    25,
    TRUE
...
(
    ...
    'Menú premium con opciones gourmet',
    35000,
    NULL,
    30,
    TRUE
...
-- ======================
INSERT INTO
    product_categories (id_product, id_category)
VALUES
    -- Sopas
    (1, 1),
    (2, 1),
...
-- ======================
INSERT INTO
    daymenus (id, creation)
VALUES (27, '2025-11-10'), -- Menú del día actual
    (28, '2025-11-11');
...
VALUES (27, 1, 1), -- Sopas (posición 1)
...
-- ======================
INSERT INTO
    client_orders (status, id_order, total)
VALUES ('PENDING', 1, 37000),
    ('PENDING', 2, 45000),
    ('PENDING', 3, 28000),
    ('COMPLETED', 4, 52000),
    ('COMPLETED', 5, 31000),
...
-- ======================
INSERT INTO
    order_detail_subproducts (id_detail, name, observations)
VALUES (
        2,
        'Caramelo extra',
        'Por separado'
