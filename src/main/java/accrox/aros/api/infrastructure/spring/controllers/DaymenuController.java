...
public class DaymenuController {
    ...
    @Operation(
        tags = "Day Menu Management",
        summary = "Get day menu by date",
        description = "This endpoint returns the day menu for a specific date with its categories and products."
    )
    ...
    public ResponseEntity<?> getDaymenuByDate(@PathVariable String date) {
        ...
        try {
            ...
            Optional<DaymenuOutput> daymenu =
                this.getDaymenuByDateUseCase.execute(targetDate);
    ...
    @Operation(
        tags = "Day Menu Management",
        summary = "Get current day menu",
        description = "This endpoint returns the menu of the current day with all its categories and products."
    )
    @GetMapping("/current")
    @PreAuthorize("hasRole('ADMIN') or hasRole('WAITER')")
    public ResponseEntity<?> getCurrentDaymenu() {
        ...
        Optional<DaymenuOutput> currentDaymenu =
            this.getCurrentDaymenuUseCase.execute();
