...
public class TableController {
    ...
    @Operation(
        ...
        description = "This endpoint returns the current status of all tables (AVAILABLE or OCCUPIED) based on active orders from today."
    )
    ...
    public ResponseEntity<List<TableStatusOutput>> getStatus() {
        ...
        List<TableStatusOutput> tablesStatus =
            this.getTablesStatusUseCase.execute();
        logger.info(
    ...
    @Operation(
        tags = "Tables Management",
        summary = "Create multiple new tables",
        description = "This endpoint allows the creation of multiple new tables by providing the required table details in the request body."
    )
    ...
    @Operation(
        tags = "Tables Management",
        summary = "Update total tables count",
        description = "Adjust the total number of tables to the provided total: create or delete tables to match the target count."
    )
